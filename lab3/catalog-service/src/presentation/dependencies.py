...
from ..infrastructure.repositories import SQLAlchemyServiceRepository, SQLAlchemyServiceCategoryRepository
...
def get_catalog_service(
    ...
    """Получить экземпляр CatalogService с SQLAlchemy репозиториями"""
    service_repository = SQLAlchemyServiceRepository(session)
    category_repository = SQLAlchemyServiceCategoryRepository(session)
